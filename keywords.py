keywords = {
    1: ['мужчин', 'мужик', 'брутал', 'мужск', 'арми', 'бокс', 'рукопаш', 'воен', 'джентельм', 'кача', 'барбер',
        'кальян', 'рыбалк', 'охот', 'гараж', 'футбол', 'мяч'],
    2: ['кошк', 'коты', 'коти', 'cat', 'собак', 'бездомн', 'приют', 'животн'],
    3: ['мем', 'mlg', 'юмор', 'смех', 'смеш', 'прикол', 'гиф', 'gif', 'анекдот', 'humor', 'прикол', 'meme', 'dank'],
    4: ['кондитер', 'рецепт', 'кулинар', 'вкусн', 'рукодел', 'шить', 'блюда', 'вышивк', 'кройк', 'вязан',
        'cook', 'handmade'],
    5: ['морти', 'мульт', 'гик', 'geek', 'adventure', 'nerd', 'cartoon', 'nintendo', 'capcom', 'настол'],
    6: ['спорт', 'фитнес', 'похуд', 'тело', 'трениров', 'физкультур', 'body', 'gym', 'workout', 'basket',
        'баскет', 'гандбол', 'плавани', 'пловец', 'гимнаст', 'бодибилд', 'мотивация', 'хоккей'],
    7: ['макияж', 'космети', 'beauty', 'парфюм', 'fashion', 'glamour', 'model', 'модель', 'мода', 'модн',
        'makeup', 'визаж'],
    8: ['marvel', 'dc', 'комикс', 'сериал', 'фильм', 'geek', 'nerd'],
    9: ['кин', 'фильм', 'movie', 'film', 'режисс', 'сериал'],
    10: ['музык', 'аудио', 'концерт', 'music', 'radio', 'радио', 'микс', 'альбом', 'jazz', 'cover', 'акустик',
         'гитар', 'drum', 'kpop', 'кпоп'],
    ...
    16: ['бизнес', 'успешн', 'лидер', 'lead', 'инвест', 'финанс', 'торгов', 'money', 'прогноз', 'ставк',
         'раскрутк', 'стартап', 'политик', 'экономик', 'навальн', 'ройзм', 'village', 'tj', 'медуза', 'етв',
         'лентач', 'образовач', 'news', 'город', 'банк'],
    ...
    28: ['девочк', 'девушк', 'маникюр', 'женск', 'императриц', 'шальн', 'прическ', 'наращ', 'ресниц', 'флорист',
         'стих', 'танец', 'танц', 'beauty', 'парфюм'],
    29: ['феи', 'ведьм', 'квест', 'сказк', 'сказоч', 'миф', 'цветы', 'цветочн', 'зодиак', 'астролог', 'гороскоп',
         'лунн', 'эзотери'],
    30: ['театр', 'выступлен', 'эстрад', 'актер', 'актёр'],
    31: ['креатив', 'дизайн', 'design', 'ремонт', 'декор', 'шрифт', 'интерьер'],
    32: ['велосипед'],
    33: ['активн', 'сноуборд', 'альпини', 'скалолаз', 'страйкбол', 'лазертаг', 'gopro', 'прогулк', 'антикафе',
         'скалодром', 'турклуб', 'поход', 'горнолыж', 'лыж'],
}
